...
@protocol LibraryKotlinSequence, LibraryKotlinIterator;
...
@interface LibraryCustomFibiKt : LibraryBase
@property (class, readonly) id<LibraryKotlinSequence> fibi __attribute__((swift_name("fibi")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Fibiprops_iosKt")))
@interface LibraryFibiprops_iosKt : LibraryBase
...
@protocol LibraryKotlinSequence
@required
